...
| AutomaticFullscreenBlockedForUrls | * | Blocks all sites from entering fullscreen automatically without user gesture. |
...
| ExtensionInstallBlocklist | * | Blocks installation of all extensions in Edge. |
